...
const Page = () => {
  ...
  const makePredictions = async () => {
    ...
    if (!!!state.uri) {
      setState((s) => ({
        ...s,
        error: "Please select a Feces image.",
      }));
      return;
    }
    ...
    const image = generateRNFile({
      name: state.fileName || "feces.jpeg",
      uri: state.uri,
    });
    await mutateAsync({
      image,
      ...
      >
          ...
          <View style={{ flexDirection: "row", flex: 1 }}>
            ...
            >
              <Text style={{ fontFamily: FONTS.bold, fontSize: 25 }}>
                Feces Image Selection
              </Text>
              <Text style={{ fontFamily: FONTS.regular, color: COLORS.gray }}>
                Select a Feces image or take it live from camera.
              </Text>
            </View>
          </View>
        ...
        >
          <View style={{ flexDirection: "row", flex: 1 }}>
            ...
            >
              <Text style={{ fontFamily: FONTS.bold, fontSize: 25 }}>
                Then, Does my Poultry have a Disease?
              </Text>
              <Text style={{ fontFamily: FONTS.regular, color: COLORS.gray }}>
