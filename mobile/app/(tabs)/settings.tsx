      ...
      >
        ...
        <SettingItem
          onPress={async () => {
            ...
            Alert.alert(
              APP_NAME,
              "Are you sure you want to reset Poultry Scope?",
              [
                {
                  text: "YES",
                  style: "default",
      ...
      >
        <SettingItem
          onPress={async () => {
            ...
            await Share.share(
              {
                url: "https://github.com/CrispenGari/PoultryScope",
                message:
                  "An AI-powered mobile tool that assists in the detection of poultry diseases from feces images, supporting early diagnosis and better flock management: Download at https://github.com/CrispenGari/PoultryScope",
                title: "Share  Poultry Scope with a Friend",
              },
              { dialogTitle: "Share Poultry Scope", tintColor: COLORS.tertiary }
            );
          }}
          title="Share Poultry Scope"
          Icon={
        ...
        <SettingItem
          ...
          title="How does Poultry Scope works"
        ...
        <SettingItem
          onPress={async () => {
            ...
            const res = await Linking.canOpenURL(
              "https://github.com/CrispenGari/PoultryScope/issues"
            );
            if (res) {
              Linking.openURL(
                "https://github.com/CrispenGari/PoultryScope/issues"
